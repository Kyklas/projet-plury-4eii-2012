...
\TransActionLink{T}{Fin Réception \\ $Donnee_{[15,8]} = R_{Data} $ }{I}
\EtapeLink{I2}{Réception deuxieme octet}{T}

\TransActionLink{T}{Fin Réception \\ $Donnee_{[7,0]} = R_{Data} $ }{I2}
\EtapeLink{I2}{}{T}
...
\TransActionLink{T20}{$Cmd.P_{[3..0]} = 1 $ $(K_p)$ \\ $SK_p$ := $Donnee$ }{E20}
\draw[->] (T20) |- (MODIF);
...
\TransActionLink{T30}{$Cmd.P_{[3..0]} = 2 $ $(T_d$) \\ $ST_d$ := $Donnee$}{E30}
\draw[->] (T30) |- (MODIF);
%\EtapeLink{E31}{}{T30}
...
\TransActionLink{T40}{$Cmd.P_{[3..0]} = 3 $ $(T_e)$ \\$ST_e$ := $Donnee$}{E40}
\draw[->] (T40) |- (MODIF);
%\EtapeLink{E41}{}{T40}
...
\TransActionLink{T50}{$Cmd.P_{[3..0]} = 4 $ $(Consigne)$\\$SConsigne$ := $Donnee_{[9,0]}$}{E50}
\draw[->] (T50) |- (MODIF);
%\EtapeLink{E51}{}{T50}
...
\TransActionLink{T60}{$Cmd.P_{[3..0]} = 5 $ $(Nb_{Acq})$\\$SNb_{Acq}$ := $Donnee_{[7,0]}$}{E60}
\draw[->] (T60) |- (MODIF);
%\EtapeLink{E61}{}{T60}
