...
\begin{figure}[!h]
	...
	\label{ponts}
	\caption{Solutions pour générer les impulsions de tension}
\end{figure}
...
\begin{figure}[!h]
	...
	\label{pont_h}
	\caption{Diagramme fonctionnel du pont en H}
\end{figure}
...
Nous avons fait une rapide évaluation du prix de notre solution. Pour se faire, nous avons pris en compte les pris pour 500 pièces de Farnell. Ce choix est discutable quand on voit la différence de prix selon les quantité commandées mais il permet tout de même de se faire une idée de ce que serait le prix de revient de notre solutions dans le cas d'une production intensive. Le prix trouvé est d'environ 26 euros pour les composants seuls. Étant donné la taille de notre carte, nous évaluons à 14 euros les coûts concernant l'achat de la carte et le routage, amenant le prix total à une quarantaine d'euros. Il est certain que ce prix peut descendre en n'utilisant pas un pont complet et en trouvant une alternative moins onéreuse au FT232. 
