...
\TransActionLink{T}{Fin Réception\\$Cmd := R_{Data}$}{I}
\EtapeLink{E1}{}{T}
...
\node[align=left,anchor=north west,at =(T1.south east),xshift=10pt] {$K_p := SK_p$\\$T_d := ST_d$\\$T_e := ST_e$\\$Consigne := SConsigne$\\$Nb_{Acq} := SNb_{Acq}$};
