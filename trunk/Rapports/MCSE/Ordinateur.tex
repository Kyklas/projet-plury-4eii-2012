...
\draw[->] (T3) edge [out=-90, in=160,out distance=4cm,in distance=9cm] node[inner sep=0,outer sep=0,minimum width=1cm,left,pos=0.3] (RET){} (T);
...
\draw[-] (T3) edge [out=-90,in=-55,out distance=1cm] (RET.center);
\draw[->] (RET.center) edge [out=180-55,in=140,out distance=4cm,in distance=4cm] (T);
